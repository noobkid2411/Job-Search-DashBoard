...
import { connectToRedux } from "./redux";
  ...
  return (
    <div className="wrapper">
      ...
      <div className="filters">
        <div className="filter-input">
          <input
            type="text"
            name="minExperience"
            placeholder={Filters.MIN_EXPERIENCE}
        ...
        <div className="filter-input">
          <input
            type="text"
            name="companyName"
            placeholder={Filters.COMPANY_NAME}
            onChange={handleFilterChange}
          />
        </div>
        <div className="filter-input">
        ...
        <div className="filter-input">
          <input
            type="text"
            name="techStack"
            placeholder={Filters.TECH_STACK}
            onChange={handleFilterChange}
          />
        </div>
        <div className="filter-input">
        ...
        <div className="filter-input">
          <input
            type="text"
            name="minBasePay"
            placeholder={Filters.MIN_BASE_PAY}
            onChange={handleFilterChange}
          />
        </div>
        <div className="filter-checkbox">
          <input type="checkbox" name="remote" onChange={handleFilterChange} />
      ...
      <div className="jobs-container">
        {filteredJobs.length > 0 ? (
          filteredJobs.map((job) => (
            <div className="job-card">
              ...
              <p>
                Expected Salary: {job.minJdSalary} - {job.maxJdSalary}{" "}
        ...
        <div className="no-jobs">  <p>No jobs found😞.</p> <p>Please adjust your filters</p></div>
        )}
        {isPopupOpen && (
          <JobDescription
            jobDescription={jobDescripton}
            onClose={togglePopup}
          />
        )}
      </div>
